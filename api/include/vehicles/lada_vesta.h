/**
 * @file lada_vesta.h
 * @brief Lada vesta specific macros.
 *
 */


#ifndef _LADA_VESTA_PLATFORM_INFO_H_
#define _LADA_VESTA_PLATFORM_INFO_H_
 ...
 *
 */
#define LADA_VESTA_OBD_BRAKE_PRESSURE_CAN_ID ( 0x220 )
...
} lada_vesta_obd_steering_wheel_angle_data_s;
...
} lada_vesta_obd_wheel_speed_data_s;
...
typedef struct
{
    ...
    uint8_t reserved[6]; /* Reserved. */
} lada_vesta_obd_brake_pressure_data_s;
